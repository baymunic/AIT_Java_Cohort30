...
/*Программа получает на вход IP-адрес в одну строку: например,
192.168.23.1 (четыре числа, разделённые точками).
...
каждое в новой строке, например: 192 168 23 1*/
        ...
        int extraDotIndex = ipAddress.indexOf('.', thirdDotIndex + 1); // ищем ещё одну точку

        // если этой точки нет, то вернётся значение -1
