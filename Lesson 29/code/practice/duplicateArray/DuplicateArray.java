package practice.duplicateArray;
...
public class DuplicateArray {
    ...
    // Вар. 3: Объявить 10 счётчиков и для каждого из них в цикле понять, сколько раз число встречалось в массиве.
    // Вар. 3: заполнить 2-х мерный массив. х[][] - это на будущее.
